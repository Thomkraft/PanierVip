 ...
 */
final class Version20250305155914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_admin TINYINT(1) NOT NULL, CHANGE pseudo pseudo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP is_admin, CHANGE pseudo pseudo VARCHAR(255) NOT NULL');
    }
}
